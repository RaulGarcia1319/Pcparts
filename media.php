            ...
            <div class="pull-right">
              ...
              <div class="form-group">
                <div class="input-group">
                 ...
                 <button type="submit" name="submit" class="btn btn-default btn-success">Subir</button>
               </div>
              </div>
             </form>
            </div>
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                  <a href="delete_media.php?id=<?php echo (int) $media_file['id'];?>" class="btn btn-danger btn-default"  title="Eliminar">
