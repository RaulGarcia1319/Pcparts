              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn">
                        <a href="edit_categorie.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-default btn-warning" data-toggle="tooltip" title="Editar">
                          <!-- <span class="glyphicon glyphicon-edit"></span> -->Editar
                        </a>
                        <a href="delete_categorie.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-default btn-danger" data-toggle="tooltip" title="Eliminar">
